...
/**
 * Manages a graph of Towns and Roads
 */
public class TownGraphManager implements TownGraphManagerInterface {
    ...
    public void populateTownGraph(File selectedFile) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            String[] splitRoad = splitLine[0].split(",");
            String[] splitTown = splitLine[1].split(",");
            String[] splitWeight = splitLine[2].split(",");
            String roadName = splitRoad[0];
            String town1 = splitTown[0];
            String town2 = splitTown[1];
            int weight = Integer.parseInt(splitWeight[0]);
            addTown(town1);
            addTown(town2);
